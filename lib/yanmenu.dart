...
class YanMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                Navigator.pushNamed(context, "/nutuk");
              },
            ),
          ),
          Container(
      ...
      ListTile(
        leading: Icon(Icons.face, color: Colors.purpleAccent),
        title: Text(
          """ÖNERİLEN ÇOCUK KİTAPLARI""",
          style: TextStyle(
              fontWeight: FontWeight.w900, color: Colors.black),
        ),
        onTap: () {
          ...
          Navigator.pushNamed(context, "/animation");
              ...
              ListTile(
                leading: Icon(Icons.bar_chart, color: Colors.lightGreenAccent),
                title: Text(
                  """GRAFİK""",
                  style: TextStyle(
                      fontWeight: FontWeight.w900, color: Colors.black),
